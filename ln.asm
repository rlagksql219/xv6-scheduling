...
putc(int fd, char c)
{
 ...
 3f8:	e8 c5 fe ff ff       	call   2c2 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 468:	50                   	push   %eax
 469:	57                   	push   %edi
 46a:	e8 53 fe ff ff       	call   2c2 <write>
...
putc(int fd, char c)
{
 ...
 4ca:	50                   	push   %eax
 4cb:	57                   	push   %edi
 4cc:	e8 f1 fd ff ff       	call   2c2 <write>
...
putc(int fd, char c)
{
 ...
 538:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 53b:	b8 67 07 00 00       	mov    $0x767,%eax
...
free(void *ap)
{
 ...
 617:	89 08                	mov    %ecx,(%eax)
  freep = p;
 619:	a3 0c 0a 00 00       	mov    %eax,0xa0c
}
 61e:	5b                   	pop    %ebx
 61f:	5e                   	pop    %esi
 620:	5f                   	pop    %edi
 ...
 63a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 63d:	a3 0c 0a 00 00       	mov    %eax,0xa0c
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6fc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6ff:	89 15 0c 0a 00 00    	mov    %edx,0xa0c
      return (void*)(p + 1);
 ...
 714:	eb e9                	jmp    6ff <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 716:	c7 05 0c 0a 00 00 10 	movl   $0xa10,0xa0c
 71d:	0a 00 00 
 720:	c7 05 10 0a 00 00 10 	movl   $0xa10,0xa10
 727:	0a 00 00 
    base.s.size = 0;
 72a:	b8 10 0a 00 00       	mov    $0xa10,%eax
 72f:	c7 05 14 0a 00 00 00 	movl   $0x0,0xa14
 736:	00 00 00 
