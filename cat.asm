  ...
  dc:	c3                   	ret    
{
  ...
  f4:	68 02 08 00 00       	push   $0x802
  f9:	6a 01                	push   $0x1
  fb:	e8 d0 03 00 00       	call   4d0 <printf>
    exit();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 46f:	f7 f6                	div    %esi
 471:	0f b6 92 30 08 00 00 	movzbl 0x830(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 4a8:	e8 c5 fe ff ff       	call   372 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 57a:	50                   	push   %eax
 57b:	57                   	push   %edi
 57c:	e8 f1 fd ff ff       	call   372 <write>
...
putc(int fd, char c)
{
 ...
 5e8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5eb:	b8 28 08 00 00       	mov    $0x828,%eax
...
free(void *ap)
{
 ...
 6c7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6c9:	a3 00 0b 00 00       	mov    %eax,0xb00
}
 6ce:	5b                   	pop    %ebx
 6cf:	5e                   	pop    %esi
 6d0:	5f                   	pop    %edi
 ...
 6ea:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6ed:	a3 00 0b 00 00       	mov    %eax,0xb00
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 7ac:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 7af:	89 15 00 0b 00 00    	mov    %edx,0xb00
      return (void*)(p + 1);
 ...
 7c4:	eb e9                	jmp    7af <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7c6:	c7 05 00 0b 00 00 04 	movl   $0xb04,0xb00
 7cd:	0b 00 00 
 7d0:	c7 05 04 0b 00 00 04 	movl   $0xb04,0xb04
 7d7:	0b 00 00 
    base.s.size = 0;
 7da:	b8 04 0b 00 00       	mov    $0xb04,%eax
 7df:	c7 05 08 0b 00 00 00 	movl   $0x0,0xb08
 7e6:	00 00 00 
