...
main(int argc, char *argv[])
{
  ...
  28:	68 50 07 00 00       	push   $0x750
  2d:	ff 74 9f fc          	pushl  -0x4(%edi,%ebx,4)
  31:	68 52 07 00 00       	push   $0x752
  36:	6a 01                	push   $0x1
  38:	e8 f3 03 00 00       	call   430 <printf>
  3d:	83 c4 10             	add    $0x10,%esp
  40:	83 c3 01             	add    $0x1,%ebx
  43:	39 de                	cmp    %ebx,%esi
  45:	75 e1                	jne    28 <main+0x28>
  47:	68 57 07 00 00       	push   $0x757
  4c:	ff 74 b7 fc          	pushl  -0x4(%edi,%esi,4)
  50:	68 52 07 00 00       	push   $0x752
  55:	6a 01                	push   $0x1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3cf:	f7 f6                	div    %esi
 3d1:	0f b6 92 60 07 00 00 	movzbl 0x760(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 548:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 54b:	b8 59 07 00 00       	mov    $0x759,%eax
...
free(void *ap)
{
 ...
 627:	89 08                	mov    %ecx,(%eax)
  freep = p;
 629:	a3 04 0a 00 00       	mov    %eax,0xa04
}
 62e:	5b                   	pop    %ebx
 62f:	5e                   	pop    %esi
 630:	5f                   	pop    %edi
 ...
 64a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 64d:	a3 04 0a 00 00       	mov    %eax,0xa04
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6e6:	e8 e5 fe ff ff       	call   5d0 <free>
  return freep;
 6eb:	8b 15 04 0a 00 00    	mov    0xa04,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 724:	eb e9                	jmp    70f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 726:	c7 05 04 0a 00 00 08 	movl   $0xa08,0xa04
 72d:	0a 00 00 
 730:	c7 05 08 0a 00 00 08 	movl   $0xa08,0xa08
 737:	0a 00 00 
    base.s.size = 0;
 73a:	b8 08 0a 00 00       	mov    $0xa08,%eax
 73f:	c7 05 0c 0a 00 00 00 	movl   $0x0,0xa0c
 746:	00 00 00 
