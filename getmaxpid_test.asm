...
int main(void)
{
   ...
   e:	83 ec 04             	sub    $0x4,%esp
	...
	max_pid = get_max_pid();
  11:	e8 14 03 00 00       	call   32a <get_max_pid>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 38f:	f7 f6                	div    %esi
 391:	0f b6 92 28 07 00 00 	movzbl 0x728(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 508:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 50b:	b8 21 07 00 00       	mov    $0x721,%eax
...
free(void *ap)
{
 ...
 60a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 60d:	a3 c0 09 00 00       	mov    %eax,0x9c0
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 67f:	76 3f                	jbe    6c0 <malloc+0xa0>
    ...
    if(p == freep)
 681:	39 05 c0 09 00 00    	cmp    %eax,0x9c0
 ...
 6a6:	e8 e5 fe ff ff       	call   590 <free>
  return freep;
 6ab:	8b 15 c0 09 00 00    	mov    0x9c0,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6cc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6cf:	89 15 c0 09 00 00    	mov    %edx,0x9c0
      return (void*)(p + 1);
 ...
 6e4:	eb e9                	jmp    6cf <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6e6:	c7 05 c0 09 00 00 c4 	movl   $0x9c4,0x9c0
 6ed:	09 00 00 
 6f0:	c7 05 c4 09 00 00 c4 	movl   $0x9c4,0x9c4
 6f7:	09 00 00 
    base.s.size = 0;
 6fa:	b8 c4 09 00 00       	mov    $0x9c4,%eax
 6ff:	c7 05 c8 09 00 00 00 	movl   $0x0,0x9c8
 706:	00 00 00 
