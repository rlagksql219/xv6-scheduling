...
int main(int argc, char *argv[])
{
  17:	8b 41 04             	mov    0x4(%ecx),%eax
    if (argc < 2)
  1a:	0f 8e 96 00 00 00    	jle    b6 <main+0xb6>
    {
  ...
  94:	75 ea                	jne    80 <main+0x80>
        {
            set_prio(priority);
  96:	6b d7 0a             	imul   $0xa,%edi,%edx
  99:	83 ec 0c             	sub    $0xc,%esp
  9c:	83 c2 01             	add    $0x1,%edx
  9f:	52                   	push   %edx
  a0:	e8 65 04 00 00       	call   50a <set_prio>
            delay(20);
  a5:	c7 04 24 14 00 00 00 	movl   $0x14,(%esp)
  ac:	e8 df 00 00 00       	call   190 <delay>
            exit();
  b1:	e8 8c 03 00 00       	call   442 <exit>
}
int main(int argc, char *argv[])
{
    if (argc < 2)
  ...
  b6:	50                   	push   %eax
  b7:	50                   	push   %eax
  b8:	68 48 09 00 00       	push   $0x948
  bd:	6a 01                	push   $0x1
  bf:	e8 fc 04 00 00       	call   5c0 <printf>
        exit();
  c4:	e8 79 03 00 00       	call   442 <exit>
        {
            pids[i] = ret;
        }
        else
  ...
  c9:	57                   	push   %edi
  ca:	57                   	push   %edi
  cb:	68 fd 08 00 00       	push   $0x8fd
  d0:	6a 01                	push   $0x1
  d2:	e8 e9 04 00 00       	call   5c0 <printf>
            exit();
  d7:	e8 66 03 00 00       	call   442 <exit>
