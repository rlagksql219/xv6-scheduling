...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     199:	ff 24 85 78 12 00 00 	jmp    *0x1278(,%eax,4)
    runcmd(lcmd->right);
    break;
...
fork1(void)
{
  ...
  case EXEC:
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     236:	68 ca 11 00 00       	push   $0x11ca
     23b:	6a 02                	push   $0x2
     23d:	e8 5e 0c 00 00       	call   ea0 <printf>
    break;
...
fork1(void)
{
  ...
  default:
    panic("runcmd");
     ...
     292:	68 c3 11 00 00       	push   $0x11c3
     297:	e8 c4 fe ff ff       	call   160 <panic>
{
  ...
  if(pid == -1)
    panic("fork");
     ...
     29f:	68 ea 11 00 00       	push   $0x11ea
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
     ...
     2ad:	68 da 11 00 00       	push   $0x11da
     2b2:	6a 02                	push   $0x2
     2b4:	e8 e7 0b 00 00       	call   ea0 <printf>
      exit();
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     2c1:	68 ef 11 00 00       	push   $0x11ef
     ...
     341:	c3                   	ret    
{
  ...
  if(pid == -1)
    panic("fork");
     ...
     345:	68 ea 11 00 00       	push   $0x11ea
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     357:	6a 54                	push   $0x54
     359:	e8 72 0d 00 00       	call   10d0 <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     3d7:	6a 0c                	push   $0xc
     3d9:	e8 f2 0c 00 00       	call   10d0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     417:	6a 0c                	push   $0xc
     419:	e8 b2 0c 00 00       	call   10d0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     457:	6a 08                	push   $0x8
     459:	e8 72 0c 00 00       	call   10d0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
     ...
     4a0:	83 c7 01             	add    $0x1,%edi
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4b1:	50                   	push   %eax
     4b2:	68 68 18 00 00       	push   $0x1868
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     505:	50                   	push   %eax
     506:	68 68 18 00 00       	push   $0x1868
  ...
  *ps = s;
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     556:	50                   	push   %eax
     557:	68 60 18 00 00       	push   $0x1860
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     575:	50                   	push   %eax
     576:	68 68 18 00 00       	push   $0x1868
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     61d:	50                   	push   %eax
     61e:	68 68 18 00 00       	push   $0x1868
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     673:	68 11 12 00 00       	push   $0x1211
     678:	53                   	push   %ebx
     679:	56                   	push   %esi
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     6fe:	68 f4 11 00 00       	push   $0x11f4
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     71f:	68 14 12 00 00       	push   $0x1214
     724:	57                   	push   %edi
     725:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     776:	68 2b 12 00 00       	push   $0x122b
     77b:	57                   	push   %edi
     77c:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     7c2:	68 1d 12 00 00       	push   $0x121d
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     80d:	68 16 12 00 00       	push   $0x1216
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     83b:	68 30 12 00 00       	push   $0x1230
     840:	56                   	push   %esi
     841:	53                   	push   %ebx
...
parseline(char **ps, char *es)
{
  ...
  while(peek(ps, es, "&")){
     ...
     8cb:	68 32 12 00 00       	push   $0x1232
     8d0:	56                   	push   %esi
     8d1:	53                   	push   %ebx
  ...
  if(peek(ps, es, ";")){
     ...
     8e1:	68 2e 12 00 00       	push   $0x122e
     8e6:	56                   	push   %esi
     8e7:	53                   	push   %ebx
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     93f:	68 14 12 00 00       	push   $0x1214
     944:	56                   	push   %esi
     945:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     96b:	68 50 12 00 00       	push   $0x1250
     970:	56                   	push   %esi
     971:	53                   	push   %ebx
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
    panic("parseblock");
     ...
     99f:	68 34 12 00 00       	push   $0x1234
  ...
  if(!peek(ps, es, ")"))
    panic("syntax - missing )");
     ...
     9ac:	68 3f 12 00 00       	push   $0x123f
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     9d9:	ff 24 85 90 12 00 00 	jmp    *0x1290(,%eax,4)
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     ...
     a97:	68 d9 11 00 00       	push   $0x11d9
     a9c:	53                   	push   %ebx
     a9d:	50                   	push   %eax
  ...
  if(s != es){
    printf(2, "leftovers: %s\n", s);
     abf:	52                   	push   %edx
     ac0:	50                   	push   %eax
     ac1:	68 52 12 00 00       	push   $0x1252
     ac6:	6a 02                	push   $0x2
     ac8:	e8 d3 03 00 00       	call   ea0 <printf>
    panic("syntax");
     acd:	c7 04 24 16 12 00 00 	movl   $0x1216,(%esp)
...
putc(int fd, char c)
{
  write(fd, &c, 1);
     ...
     e78:	e8 c5 fe ff ff       	call   d42 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
  write(fd, &c, 1);
     ...
     ee8:	50                   	push   %eax
     ee9:	57                   	push   %edi
     eea:	e8 53 fe ff ff       	call   d42 <write>
...
putc(int fd, char c)
{
  write(fd, &c, 1);
     ...
     f4a:	50                   	push   %eax
     f4b:	57                   	push   %edi
     f4c:	e8 f1 fd ff ff       	call   d42 <write>
     ...
     f61:	e8 dc fd ff ff       	call   d42 <write>
  int c, i, state;
  uint *ap;
...
putc(int fd, char c)
{
  write(fd, &c, 1);
     fde:	50                   	push   %eax
     fdf:	57                   	push   %edi
     fe0:	e8 5d fd ff ff       	call   d42 <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    102f:	50                   	push   %eax
    1030:	57                   	push   %edi
    1031:	e8 0c fd ff ff       	call   d42 <write>
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    113e:	53                   	push   %ebx
    113f:	e8 66 fc ff ff       	call   daa <sbrk>
  if(p == (char*)-1)
