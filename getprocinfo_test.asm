...
int main(void)
{
  ...
  19:	6a 0c                	push   $0xc
  1b:	e8 40 06 00 00       	call   660 <malloc>
  20:	89 c6                	mov    %eax,%esi

	max_pid = get_max_pid();
  22:	e8 43 03 00 00       	call   36a <get_max_pid>
  27:	89 c7                	mov    %eax,%edi
	
	printf(1, "PID \t PPID \t SIZE \t Number of Context Switch \t \n");
  29:	58                   	pop    %eax
  2a:	5a                   	pop    %edx
  2b:	68 50 07 00 00       	push   $0x750
  30:	6a 01                	push   $0x1
  ...
  45:	83 c3 01             	add    $0x1,%ebx
		get_proc_info(i, p_info);
  48:	e8 25 03 00 00       	call   372 <get_proc_info>
  ...
  50:	39 df                	cmp    %ebx,%edi
  52:	7d ec                	jge    40 <main+0x40>
		get_proc_info(i, p_info);
	}
  ...
  57:	56                   	push   %esi
  58:	e8 73 05 00 00       	call   5d0 <free>
	exit();
  5d:	e8 50 02 00 00       	call   2b2 <exit>
  62:	66 90                	xchg   %ax,%ax
  64:	66 90                	xchg   %ax,%ax
  66:	66 90                	xchg   %ax,%ax
  68:	66 90                	xchg   %ax,%ax
...
putc(int fd, char c)
{
 ...
 548:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 54b:	b8 84 07 00 00       	mov    $0x784,%eax
...
free(void *ap)
{
 ...
 627:	89 08                	mov    %ecx,(%eax)
  freep = p;
 629:	a3 30 0a 00 00       	mov    %eax,0xa30
}
 62e:	5b                   	pop    %ebx
 62f:	5e                   	pop    %esi
 630:	5f                   	pop    %edi
 ...
 64a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 64d:	a3 30 0a 00 00       	mov    %eax,0xa30
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
